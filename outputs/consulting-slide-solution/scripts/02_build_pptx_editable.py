#!/usr/bin/env python3
"""
slides-source/12-ai-workflow-asis.html の内容を、編集可能な PowerPoint (.pptx) として再構築する。
- 文字はすべてネイティブテキストボックス
...
def build():
    ...
    # 保存
    # ==========================================================
    out = Path(__file__).resolve().parent.parent / "pptx" / "12-ai-workflow-asis-editable.pptx"
