...
- [x] [DNS](./tier4-other/dns.md) — Authoritative / DNSSEC / Secondary / Internal DNS / DNS Firewall
- [x] [Registrar](./tier4-other/registrar.md) — At-cost ドメイン登録
- [x] [Email Routing](./tier4-other/email-routing.md) — 受信転送 + Email Workers
- [x] [Zaraz](./tier4-other/zaraz.md) — サーバーサイド Tag Manager
- [x] [Analytics & Logs](./tier4-other/analytics-logs.md) — Web Analytics / Logpush / Log Explorer / Workers Observability
- [x] [Radar](./tier4-other/radar.md) — インターネットの天気予報
- [x] [Realtime](./tier4-other/realtime.md) — SFU / TURN / RealtimeKit (Dyte)
- [x] [Containers](./tier4-other/containers.md) — Workers から呼び出すコンテナワークロード
- [x] [Sandbox SDK](./tier4-other/sandbox-sdk.md) — AI エージェント向け実行サンドボックス
- [x] [AI Search & AI Crawl Control](./tier4-other/ai-search.md) — Managed RAG / AI クローラ制御
- [x] [Secrets Store](./tier4-other/secrets-store.md) — Account-scope の機密管理
- [x] [Workers for Platforms / Cloudflare for SaaS](./tier4-other/workers-for-platforms.md) — マルチテナント SaaS のコード/ドメイン分離
- [x] [Pipelines](./tier4-other/pipelines.md) — Streaming ETL → R2 (Iceberg/Parquet)
- [x] [R2 Data Catalog & R2 SQL](./tier4-other/r2-data-catalog.md) — Iceberg レイクハウス + サーバレス SQL
